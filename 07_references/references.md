...
- [ ] A source on sealing chemistry (hydration of the oxide closing the pores)
- [ ] ASTM D638 tensile geometry (only if I extend into mechanical testing later)

> Note: keep these in my own words in the write-up. For exact figures, cite the source rather
> than copying its wording.
