...
**Setup:** bath concentration, temperature, power supply mode, cathode, jig notes.

**Batches / coupons run:**

**What happened:** current over time, voltage, temperature drift, timing.

**Problems / surprises:** be specific.

**What I changed or will change next time:**

**Photos taken:** filenames + which folder.
```
...
**Setup:** ~1:1 battery acid : distilled water bath, ~20 °C, lead cathode, voltage-only PSU.

**Batches / coupons run:** B0-1, B0-2.
...
**Photos:** 04_images/coupons/B0-1_face_post.jpg, B0-2_face_post.jpg
